...
export default function CourseCard({ course }) {
  return (
    <motion.div
      ...
      className="bg-white rounded-lg p-5 w-64 flex-shrink-0 cursor-pointer select-none"
    >
      <motion.div 
        initial={{ scale: 1 }}
      ...
      <motion.div
        ...
        className="flex items-center text-purple-700 font-bold text-lg space-x-2"
      >
